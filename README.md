...
- `website/` 是独立的 React + Vite 官网，通过 Cloudflare Worker 同域提供静态页面和预约演示 API，预约通知使用可配置的外部 SMTP 服务发送。
...
website/               官网、预约演示 Worker 和 Cloudflare 部署配置
...
官网 SMTP 本地配置和 Cloudflare Secrets 说明见 [`website/README.md`](website/README.md)。
