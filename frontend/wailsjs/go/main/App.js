...
export function ApplyRecommendedDingTalkSettings() {
  return window['go']['main']['App']['ApplyRecommendedDingTalkSettings']();
}

export function ApplyRecommendedDingTalkSettingsForProfile(arg1) {
  return window['go']['main']['App']['ApplyRecommendedDingTalkSettingsForProfile'](arg1);
}
